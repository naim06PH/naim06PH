<h1 align="center">Hi, I'm <strong>Naim Penabad Hermida</strong> <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>

<p align="center">
  <a href="https://github.com/DenverCoder1/readme-typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Time+New+Roman&color=%23C8BE25&size=25&center=true&vCenter=true&width=600&height=100&lines=Data+Science+%7C+AI+Enthusiast;Junior+Web+Developer;Python+%7C+SQL+%7C+AWS;Building+Data-Driven+Solutions" alt="typing">
  </a>
</p>
...
<h2>📌 About Me</h2>
<ul>
  <li>💡 Web Applications Development student transitioning into <strong>Data Science & AI</strong>.</li>
  <li>📊 Experience in data analysis, ETL processes, and building data-driven solutions.</li>
  <li>⚙️ Strong foundation in both <strong>front-end</strong> and <strong>back-end</strong> development.</li>
  <li>☁️ Interested in <strong>AWS</strong> and cloud-based data architectures.</li>
  <li>🤝 Team player with a proactive mindset and continuous learning approach.</li>
  <li>🎯 Currently working as <strong>Junior Data Analyst (AI & Data)</strong> at Deloitte.</li>
</ul>

<h2>🚀 Core Skills</h2>
<ul>
  <li><strong>Languages:</strong> Python, SQL, JavaScript, Java, PHP</li>
  <li><strong>Data:</strong> Data Analysis, ETL, Data Cleaning, Basic Machine Learning</li>
  <li><strong>Web:</strong> HTML, CSS, React, Bootstrap</li>
  <li><strong>Tools:</strong> Git, Docker, IICS, Control-M</li>
  <li><strong>Cloud:</strong> IICS, AWS (learning)</li>
</ul>
...
<ul>
  <li><strong>TFC: </strong><a href="https://github.com/naim06PH/Autoaudit-AI">Autoaudit-AI</a></li>
...
<h2>📈 Current Focus</h2>
<ul>
  <li>📊 Improving data analysis and visualization skills</li>
